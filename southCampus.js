...
function calculatePeriod(totalSeconds) {
    const periods = [
        ...
        { name: "Period 5",      start: 39600, end: 42960, periodID: "5" },
        { name: "Lunch",         start: 42960, end: 44760, periodID: "Lunch" },
...
function calculatePeriodWednesday(totalSeconds) {
    const periods = [
        ...
        { name: "Period 5",      start: 37200, end: 39960, periodID: "5" },
        { name: "Lunch",         start: 39960, end: 41760, periodID: "Lunch" },
